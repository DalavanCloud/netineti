...
def get_ascii_ratio(words):
    """Calculates ascii/nonascii ratio in a words
...
def remove_trailing_period(string):
    ...
    """
    # sometimes people abbreviate genus to 2 or 3 letters,
    # we do not catch these cases
