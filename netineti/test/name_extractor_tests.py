...
class TestNameExtractor(unittest.TestCase):
    ...
    def test_genus(self):
        ...
        self.assertEqual(ne.canonical_list(), ["Pomatomus"])
    ...
    def test_named_hybrid(self):
        ...
        ne = NameExtractor(parsed)
        self.assertEqual(ne.canonical_list(), ['×', 'Plantago', 'major'])
